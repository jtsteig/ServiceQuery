...
class UserIntegrationTests(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        body = [{
			...
			"operatingCities": ["Denver", "Thornton", "Golden", "Arvada", "Centennial", "Parker"],
			"workTypes": ["Maid Service", "House Cleaning", "Moving Services", "Packing"],
			"reviews": [{
				"ratingScore": 4,
				"customerComment": "Move out cleaning"
			}, {
				"ratingScore": 2,
				"customerComment": "Broke our dishes because they didn't pack right"
			}, {
				"ratingScore": 5
			}]
		}, {
			...
			"operatingCities": ["Denver", "Commerce City", "Thornton", "Henderson", "Northglenn"],
			"workTypes": ["Packing", "Moving Services"],
			"reviews": [{
				"ratingScore": 5,
				"customerComment": "Helped us move across the country, they're great!"
			}]
		}]
        ...
        self.service_id = respBody[0].get(
    ...
    def test_get_all_services(self):
        ...
        self.assertEqual(len(respBody), 2)
